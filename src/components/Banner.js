...
const Banner = () => {
  return (
    <Section>
        <ImgContainer>
            <img width={500} height={400}  src={img1} alt="Kongs" />
            <img width={500} height={400}  src={img2} alt="Kongs" />
            <img width={500} height={400}  src={img3} alt="Kongs" />
            <img width={500} height={400}  src={img4} alt="Kongs" />

        </ImgContainer>
        <Title>Join  <br /> DigiKong  </Title>
        <BtnContainer>
